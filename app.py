...
if st.button("🚀 Generovat PRO prompt"):
    if b_txt:
        ...
        p_f = f"Jsi senior copywriter. Napiš RSA (15 nadpisů do 30 zn, 4 popisky do 90 zn). CTR zaměření. Brief: {b_txt}.{u_p}"
        st.code(p_f)
...
v_raw = st.text_area("AI texty sem (každý na nový řádek)", height=150)
